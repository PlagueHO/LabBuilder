...
Configuration XML
=================
Documentation for the LabBuilder Configuration XML can be found in the file [schema/labbuilderconfig-schema.md](labbuilder/labbuilder/schema/labbuilderconfig-schema.md).
